...
?>
<table style="width:100%;text-align: center;border-collapse: collapse;" border="1" align="center">
  <tr>
    <th>Id</th>
    <th>Mã sp</th>
    <th>Tên sản phẩm</th>
   ...
   <tr>
    <td colspan="8">
      ...
      <?php
        if(isset($_SESSION['dangky'])){
          ?>
           <p><a href="index.php?quanly=camon">Đặt hàng</a></p>
      <?php
        }else{
      ?>
        <p><a href="index.php?quanly=dangky">Bạn chưa có tài khoản?<br>Đăng nhập/Đăng ký để đặt hàng.</a></p>
      <?php
        }
      ?>
